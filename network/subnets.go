...
func CreateSubnet(ctx *pulumi.Context, vpcId pulumi.StringInput, subnetType string, subnetName string, subnetRange string) (subnetConfigOjbect *ec2.Subnet, createSubnetErr error) {
	...
	subnetConfig, createSubnetErr := ec2.NewSubnet(ctx, subnetName, &ec2.SubnetArgs{
